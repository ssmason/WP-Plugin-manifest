...
// Plugin constants.
define( 'SATORI_MANIFEST_VERSION', '1.0.0' );
...
// Manual includes (fallback if autoloader not present).
...
require_once SATORI_MANIFEST_PATH . 'includes/class-options.php';
require_once SATORI_MANIFEST_PATH . 'includes/class-patterns.php';
require_once SATORI_MANIFEST_PATH . 'includes/class-block.php';
require_once SATORI_MANIFEST_PATH . 'admin/class-admin-ajax.php';
